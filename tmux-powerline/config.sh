...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="power-dajabe"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/djb/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/djb/.mailcheckrc"
# }
